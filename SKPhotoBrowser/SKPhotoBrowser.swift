...
open class SKPhotoBrowser: UIViewController {
    ...
    func setup() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.videoScrubberStart), name: NSNotification.Name(rawValue: SKVideoScrubber.Start), object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(self.videoScrubberEnd), name: NSNotification.Name(rawValue: SKVideoScrubber.End), object: nil)
    }
...
public extension SKPhotoBrowser {
    ...
    func popupShare(includeCaption: Bool = true) {
        ...
        if let caption = photo.captionTitle , includeCaption {
